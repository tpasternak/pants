...
class ExportFastpassTask(ResolveRequirementsTaskBase, IvyTaskMixin, CoursierMixin):
    ...
    def prepare(cls, options, round_manager):
        ...
        # - export deviation
        if options.libraries or options.libraries_sources:
    ...
    def generate_targets_map(self, targets, zinc_args_for_all_targets, runtime_classpath, classpath_products=None):
        ...
        def process_target(current_target):
            ...
            info = {
                ...
                "target_base": current_target.target_base,
                "java_sources": [],
                "exports": [],
                "is_modulizable": id(current_target) in is_modulizable_target
                # - export deviation
            }
            ...
            for dep in current_target.dependencies:
                info["dependencies"].append(dep.address.spec)
...
class ExportFastpass(ExportFastpassTask, ConsoleTask):
    """Export project information in JSON format.

    Intended for exporting project information for http://go/fastpass.
    """
